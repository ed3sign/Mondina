...
begin
  ...
  qrProdCassetto.Active := False;
  qrProdCassetto.SQL.Text := 'SELECT [Prodotti_Cassetti].*, [Prodotti].[CodiceAcquisto], [Prodotti].[Nome], [Prodotti].[Tipologia] ' +
...
begin
  qrProdotti.Active := False;
  qrProdotti.SQL.Text := 'SELECT [Codice], [CodiceAcquisto], [Tipologia], [Nome], [QtaTotale] ' +
                         'FROM [Prodotti] ' +
                         'WHERE (1 = 1)';
